...
- [Vue.js > Динамическое переключение компонентов](https://ru.vuejs.org/v2/guide/components.html#Динамическое-переключение-компонентов)
...
- [Использование компонентов в заголовках](#using-components-in-headers)
